    ...
    automations:[
        {
            ...
            description:'Generate and post thank-you responses',
            priority:'medium',
            status:'active',
            executions: 89, 
            avg_response:2.3,
        ...
        },
        {
            ...
            description:'Analyze and suggest content improvements',
            priority:'low',
            status:'paused',
            executions:'23',
            avg_response:2.3,
        ...
        trigger:'Engagement rate drops below 2.5%',
        description:'Monitor for new reviews and rating changes',
        priority:'high',
        status:'active',
        executions:'247',
        avg_response:2.3,
